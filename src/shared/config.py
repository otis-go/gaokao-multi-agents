...
class Stage1AblationConfig:
    ...
    Usage:
    CLI: python run.py --run-mode full --stage1-skip agent2
    CLI: python run.py --run-mode full --use-random-dims  # Random dimension ablation
    CLI: python run.py --run-mode full --low-freq-random  # Low-frequency random dimensions
    CLI: python run.py --run-mode full --low-freq-ablation  # Low-frequency ablation
    CLI: python run.py --run-mode full --skip-stage1-dims  # No-control Baseline
    """
